...
item2.EMAIL;type=INTERNET: cpmjhon@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://github.com/CpmJhon\n
...
let teks = `⬣ LIST GROUP BY Cpm_Jhon\n\nTotal Group : ${anu.length} Group\n\n`
for (let x of anu) {
...
ɪ ᴀᴍ *Bot Cpm_Jhon - MD* ᴀᴜᴛᴏᴍᴀᴛᴇᴅ ꜱyꜱᴛᴇᴍ (ᴡʜᴀᴛꜱᴀᴩᴩ ʙᴏᴛ) ᴛʜᴀᴛ ᴄᴀɴ ʜᴇʟᴩ ᴛᴏ ᴅᴏ ꜱᴏᴍᴇᴛʜɪɴɢ, ꜱᴇᴀʀᴄʜ ᴀɴᴅ ɢᴇᴛ ᴅᴀᴛᴀ / ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴏɴʟy ᴛʜʀᴏᴜɢʜ ᴡʜᴀᴛꜱᴀᴩᴩ
...
koy.sendMessage(m?.chat, {
    ...
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            newsletterJid: '120363208048174194@newsletter',
...
koy.sendMessage(m.chat, {
      ...
      externalAdReply: {
      title: 'Cpm_Jhon-MD',
      body: 'Creator : AlwaysCpm_Jhon',
      thumbnailUrl: 'https://pomf2.lain.la/f/lez5oxvq.png',
      sourceUrl: `https://youtube.com/@galeri_car_cpm8048`,
      mediaType: 1,
      renderLargerThumbnail: true
      }
      }
...
koy.sendMessage("6285894955362@s.whatsapp.net", {text:`🕊️ Sukses Bang...`})
}
break
///
case "promote":{
...
case "shadow-sky":
case "flaming":{
if (!text) return m.reply(`Ex : ${prefix + command} Cpm_JhonDev`)
await loading()
...
case 'sewabot':
case 'sewa':
m.reply(`✨ *_Harga Sewa Cpm_Jhon-MD_*
❃ Minggu 5k / Group
...
case "runtime": {
const tek = `*Hello* @${m?.sender.split('@')[0]}
_*Cpm_Jhon MD Aktif Selama ${runtime(process.uptime())}*_
`
koy.sendMessage(m?.chat, {
    document: fs.readFileSync("./package.json"),
    jpegThumbnail: { url: global.thumb },
...
case 'totalfitur':
case 'totalfeature':{
m.reply(`_*Total Feature Cpm_Jhon MD Adalah :*_ ${totalFitur()}`)
}
break
...
newsletterJid: '120363208048174194@newsletter',
serverMessageId: null,
newsletterName: "Cpm_Jhon-MD"
}
}
}, { quoted: { key: { participant: '6285894955362@s.whatsapp.net', remoteJid: "6285894955362@s.whatsapp.net" }, message: { conversation: "Cpm_Jhon-MD Production Terverifikasi WhatsApp_"}}})
user.pc = new Date() * 1;
}
}
} catch (err) {
koy.sendMessage('6285894955362@s.whatsapp.net', { text: util.format(err) })
}
}
